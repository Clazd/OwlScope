 ...
 */
export function MicroLabel({ children, as: Tag = "span", className, id, strong = false }: MicroLabelProps) {
  return (
    <Tag id={id} data-mono className={cn("type-micro", strong ? "text-ink-2" : "text-ink-3", className)}>
      {children}
    </Tag>
  );
}
