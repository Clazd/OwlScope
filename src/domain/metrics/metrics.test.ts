...
function content(id: string, publishedAt: string): ContentItem { return { id, topicId: "t", personaVersion: 1, status: "published", angle: "opinion", thesis: "", text: "", sentences: [], characterCount: 0, fingerprintScore: 0, sourceIds: [], critique: null, validation: null, similarity: null, reasoning: "", override: null, visualPrompt: null, thread: null, rejectionReasons: [], provider: "", model: "", runId: "r", createdAt: publishedAt, updatedAt: publishedAt, publishedAt, publicUrl: null }; }
